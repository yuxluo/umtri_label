...
__doc__ = None
__file__ = '/usr/local/lib/python3.7/dist-packages/cryptography/hazmat/bindings/_openssl.abi3.so'
...
class lib(_mod_builtins.object):
    ...
    def EVP_DigestSignUpdate():
        'int EVP_DigestSignUpdate(EVP_MD_CTX *, void *, size_t);\n\nCFFI C function from _openssl.lib'
        pass
    ...
    @staticmethod
    def sk_ACCESS_DESCRIPTION_pop_free():
        'void sk_ACCESS_DESCRIPTION_pop_free(Cryptography_STACK_OF_ACCESS_DESCRIPTION *, void(*)(ACCESS_DESCRIPTION *));\n\nCFFI C function from _openssl.lib'
        pass
